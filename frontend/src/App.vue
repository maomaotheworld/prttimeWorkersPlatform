...
const desktopNavs = [
  ...
  { path: "/teams", name: "所屬團隊管理", iconComponent: Flag, requiresAuth: true },
  { path: "/seatmap", name: "座位圖", iconComponent: Grid, requiresAuth: true },
...
const mobileNavs = [
  ...
  { path: "/teams", name: "所屬團隊", icon: "Flag", requiresAuth: true },
  { path: "/seatmap", name: "座位圖", icon: "Grid", requiresAuth: true },
